    ...
    <div className="space-y-8 relative">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="glass-card p-6 rounded-xl border border-white/5 flex flex-col justify-between">
              ...
              <span
                className={`w-3.5 h-3.5 rounded-full ${
                  instrument.status === 'ACTIVE'
                    ? 'bg-emerald-500 glow-success'
                    : instrument.status === 'CALIBRATION_DUE'
                    ? 'bg-amber-500 glow-warning'
          ...
          <div className="flex flex-col gap-2.5 pt-6 border-t border-gray-800/80 mt-6">
            <button
      ...
      {!prepGuidance ? (
        <div className="glass-card p-6 rounded-xl border border-white/5 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <button
            ...
            className="btn-transition px-5 py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-semibold rounded-lg shrink-0 flex items-center gap-2 shadow-lg shadow-indigo-600/10"
          >
            {prepLoading ? (
            ...
            {prepLoading ? 'Orchestrating Agents...' : 'Prepare Guidance'}
          </button>
        </div>
      ) : (
        <div className="glass-card p-6 rounded-xl border border-white/5 space-y-6">
          ...
          {prepError && (
            <div className="p-4 bg-red-500/10 border border-red-500/20 text-red-400 rounded-lg text-xs">{prepError}</div>
          )}
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm px-4 overflow-y-auto py-8">
          <div className="w-full max-w-3xl glass-panel p-6 rounded-2xl glow-primary relative my-auto">
            ...
            <p className="text-gray-400 text-xs mb-6">
              Log field validation findings. Acceptable tolerance limits: ±{instrument.maxPermissibleError}% MPE.
            </p>
            ...
            <form onSubmit={handleAddCalibration} className="space-y-5">
                  ...
                  <div className="space-y-2 max-h-48 overflow-y-auto border border-gray-800 rounded-lg p-3 bg-slate-950/20">
                    {availableStandards.map((std) => {
                      ...
                      return (
                        <div
                          key={std.id}
                          className="p-2.5 rounded-lg bg-[#0c1220]/60 border border-gray-800/80 flex flex-col gap-2"
                        >
              ...
              <div className="flex justify-end gap-3 pt-4 border-t border-gray-800 text-sm">
                ...
                <button
                  ...
                  className="btn-transition bg-indigo-600 hover:bg-indigo-700 text-white font-semibold py-2 px-6 rounded-lg shadow-md font-sans"
                >
      ...
      {isDeleteModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm px-4">
          <div className="w-full max-w-md glass-panel p-6 rounded-2xl border border-red-500/20 relative animate-fade-in">
            <button
            ...
            <p className="text-gray-400 text-xs mb-6">
              Decommissioning will remove this device from active tracking. This is an audited action.
            </p>
      ...
      {isWoModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm px-4">
          <div className="w-full max-w-md glass-panel p-6 rounded-2xl glow-primary border border-white/5 relative">
            ...
            <p className="text-gray-400 text-xs mb-6">
              Schedule calibration validation maintenance task for {instrument.tagNumber}.
            </p>
      ...
      {isSubmitReviewOpen && reviewCal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
          <div className="bg-[#0c1220] border border-gray-800 w-full max-w-md rounded-2xl overflow-hidden shadow-2xl flex flex-col font-sans">
            ...
            <form onSubmit={handleSubmitReview}>
              ...
              <div className="px-6 py-4 border-t border-gray-800/80 flex justify-end gap-3 bg-[#080d16] text-xs">
                <button
                  type="button"
